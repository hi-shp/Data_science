...
실시간 2D 시뮬레이터 4배속 고속 자율운항 5회 연속 완주 데모 (동적 장애물 필드 내 3차 베지어 곡선 기반 다단 갭 탐색 및 100% 무충돌 회피 주행)

고화질 원본 비디오는 [images/simulation_5_laps.mp4](images/simulation_5_laps.mp4) 파일로도 직접 확인하실 수 있습니다.
...
통합 콕핏 대시보드 인터페이스: 선체 정밀 기하 모델, 1차(하늘색) 및 2차(주황색) 베지어 궤적, 2D 궤적 프로파일 및 실시간 텔레메트리 HUD
...
베지어 곡선 원리: 제어점 p0, p1, p2, p3을 통해 매끄러운 3차 함수 궤적 생성
